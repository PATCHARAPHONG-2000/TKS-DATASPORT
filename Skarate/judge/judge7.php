...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="row score"  >
            <!-- Left Side -->
            <div class="col-md-5 mt-5 mx-auto" style="background-color: brown;" >
                <h2 class="mb-4 text-center">AKA</h2>
                <form>
                    <div class="mb-3">
                        <label for="aka_judge1_number1" class="form-label">JUDGE 7 :</label>
            ...
            <div class="col-md-5 mt-5 mx-auto">
                ...
                <form>
                    <div class="mb-3">
                        <label for="ao_judge1_number1" class="form-label">JUDGE 7 :</label>
